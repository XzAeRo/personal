...
\begin{aside}
  ...
  \section{Dirección}
    Las Barrancas 2581,
    Depto. E203, Quilpué, Chile
    ~
  \section{Fono}
    +56 9 8897 2537
    ~
  \section{Mail}
    \underline{\href{mailto:victor.gonzalezro@gmail.com}{victor.gonzalezro@gmail.com}}
    ~
  \section{Web \& Git}
  	%\underline{\href{http://martinothamar.github.io}{martinothamar.github.io}}
    \underline{\href{https://cl.linkedin.com/in/vagonzal}{linkedin.com/in/vagonzal}}
    \underline{\href{https://github.com/martinothamar}{github.com/xzaero}}
    ~
